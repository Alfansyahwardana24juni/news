...
<html>
	...
	<body class="font-[Poppins] pb-[72px]">
		...
		<section id="Best-authors" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			...
			<div class="grid grid-cols-6 gap-[30px]">
				...
				<a href="{{route('front.author', $author->slug)}}" class="card-author">
    ...
    <div class="flex flex-col gap-3 shrink-0 w-fit">
        ...
        @else
            <div class="w-[900px] h-[120px] flex shrink-0 border border-[#EEF0F7] rounded-2xl overflow-hidden">
                <img src="{{ Storage::url($bannerads->thumbnail ?? 'default-thumbnail.jpg') }}" class="object-cover w-full h-full" alt="ads" />
            </div>
        @endif
